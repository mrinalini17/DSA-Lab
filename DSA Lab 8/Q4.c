/*4. Write a menu driven program to implement Deques (both Input restricted and
Output-restricted) operations such as Enqueue, Dequeue, Peek, Display of elements, IsEmpty, IsFull using
static array.*/
#include<conio.h>
# include<stdio.h>
//using namespace std;
